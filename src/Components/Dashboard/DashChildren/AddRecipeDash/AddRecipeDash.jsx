...
- 1 tsp salt'></textarea>
                    ...
                    <div className='md:flex items-center md:justify-between'>
                        <div>
                            <fieldset className="fieldset">
                                ...
                                <select defaultValue="Pick a browser" name='cuisine' className={`select w-full ${!themes && 'text-black'}`}>
                        ...
                        <div>
                            <fieldset className="fieldset ">
                                ...
                                <input type="number" name='time' required className={`${!themes && 'text-black'} input w-20 md:w-full`} placeholder="0" />
                    ...
                    <div className='mt-2 space-y-2 md:flex md:justify-between md:items-center'>
                        <div className='flex items-center gap-1'>
                            <p onClick={handleLike} className={`font-bold cursor-pointer ${liked ? ' cursor-not-allowed' : ''}`}>{likes > 0 ? <FaHeart color='red' /> : <FaRegHeart color={!themes && 'black'} />} </p>
